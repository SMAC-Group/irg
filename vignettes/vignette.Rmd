...
```{r}
causal_stat(root = gene_signals$root, shoot = gene_signals$shoot, times = times, theta = theta, alternative = "rtos")
```
...
```{r}
granger_test(root = gene_signals$root, shoot = gene_signals$shoot, times = times, theta = theta, alternative = "rtos")
```
